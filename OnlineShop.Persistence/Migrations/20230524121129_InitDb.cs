        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    CardDataHash = table.Column<string>(type: "nvarchar(max)", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ProductPropertyValuesInventories", x => x.Id);
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ProductPropertyValuesInventoryId = table.Column<int>(type: "int", nullable: false),
                    CreateDate = table.Column<DateTime>(type: "datetime2", nullable: false),
                    UpdateDate = table.Column<DateTime>(type: "datetime2", nullable: false)
                },
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_ProductPropertyValue_ProductPropertyValuesInventories_ProductPropertyValuesInventoryId",
                        column: x => x.ProductPropertyValuesInventoryId,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ProductPropertyValue_ProductPropertyValuesInventoryId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ProductPropertyValuesInventories_ProductId",
