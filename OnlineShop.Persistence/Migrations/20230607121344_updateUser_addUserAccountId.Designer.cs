...
namespace OnlineShop.Persistence.Migrations
{
    ...
    [Migration("20230607121344_updateUser_addUserAccountId")]
    partial class updateUser_addUserAccountId
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("OnlineShop.Domain.Models.UserAccount", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<int>", b =>
                {
                    b.HasOne("OnlineShop.Domain.Models.UserAccount", null)
                        .WithMany()
            ...
            modelBuilder.Entity("OnlineShop.Domain.Models.User", b =>
                {
                    ...
                    b.HasOne("OnlineShop.Domain.Models.UserAccount", "UserAccount")
                        .WithMany()
